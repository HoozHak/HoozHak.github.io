...
function processCookie() // Declare a new function named processCookie() containing the following statement
{
    var expiresDate = new Date();  //4a
...
function populateInfo() // Declare a new function named processCookie() containing the following statement
{
    if (document.cookie)
    {
...
function handleSubmit() // Declare a new function named handleSubmit() that takes a single parameter, evt
{
